...
$KRATOS step record-agent "$SESSION_ID" athena opus "<action: e.g. Writing PRD for <feature>>"

# Record each document you create
$KRATOS step record-file "$SESSION_ID" ".claude/feature/<name>/prd.md" "created"
```
