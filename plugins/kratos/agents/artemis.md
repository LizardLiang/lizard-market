...
$KRATOS pipeline update --feature FEATURE_NAME --stage 6-test-plan --status complete --document test-plan.md
...
$KRATOS step record-agent "$SESSION_ID" artemis sonnet "Writing test plan for FEATURE_NAME"
