...
```bash
# 1. Run the CLI
kratos pipeline update --feature <name> --stage 2.5-decomposition --status complete --document decomposition.md
...
kratos step record-agent "$SESSION_ID" daedalus sonnet "<action: e.g. Decomposing <feature> into tasks>"
