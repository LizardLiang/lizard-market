...
$KRATOS pipeline update --feature FEATURE_NAME --stage 5-spec-review-sa --status complete --verdict sound --document spec-review-sa.md
...
$KRATOS step record-agent "$SESSION_ID" apollo opus "Reviewing tech spec for FEATURE_NAME"

# Record each document you create
$KRATOS step record-file "$SESSION_ID" ".claude/feature/<name>/spec-review-sa.md" "created"
```
