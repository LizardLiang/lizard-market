...
```bash
# 1. Run the CLI
kratos pipeline update --feature <name> --stage 3-tech-spec --status complete --document tech-spec.md
...
kratos step record-agent "$SESSION_ID" hephaestus opus "<action: e.g. Writing tech spec for <feature>>"
