...
!`node "${CLAUDE_PLUGIN_ROOT}/hooks/launch.cjs" agent load apollo --resolve --part body`

!`node "${CLAUDE_PLUGIN_ROOT}/hooks/launch.cjs" agent load apollo --resolve --part extras`
