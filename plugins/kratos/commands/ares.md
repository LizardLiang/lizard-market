...
!`node "${CLAUDE_PLUGIN_ROOT}/hooks/launch.cjs" agent load ares --resolve --part body`

!`node "${CLAUDE_PLUGIN_ROOT}/hooks/launch.cjs" agent load ares --resolve --part extras`
