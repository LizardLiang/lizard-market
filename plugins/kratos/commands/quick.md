...
- Run the clarity loop: score Target/Approach/Validation, ask one question per turn, re-score after each answer, keep asking until PLAN_READY (ambiguity ≤ 0.10)
