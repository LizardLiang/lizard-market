...
!`node "${CLAUDE_PLUGIN_ROOT}/hooks/launch.cjs" agent load prometheus --resolve --part body`

!`node "${CLAUDE_PLUGIN_ROOT}/hooks/launch.cjs" agent load prometheus --resolve --part extras`
