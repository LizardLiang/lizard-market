...
!`node "${CLAUDE_PLUGIN_ROOT}/hooks/launch.cjs" agent load hera --resolve --part body`

!`node "${CLAUDE_PLUGIN_ROOT}/hooks/launch.cjs" agent load hera --resolve --part extras`
